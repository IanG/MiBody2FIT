...
public class DeviceInfoMesg extends Mesg {
   ...
   static {            
      ...
      field_index++;
      deviceInfoMesg.addField(new Field("ant_device_type", 1, 2, 1, 0, "", false));
      subfield_index = 0;
      deviceInfoMesg.fields.get(field_index).subFields.add(new SubField("antplus_device_type", 2, 1, 0, ""));
      deviceInfoMesg.fields.get(field_index).subFields.get(subfield_index).addMap(22, 1);
      subfield_index++;
      field_index++;
   ...
   public void setAntDeviceType(Short antDeviceType) {
      setFieldValue(1, 0, antDeviceType, Fit.SUBFIELD_INDEX_MAIN_FIELD);
   }
   ...
   public Short getAntplusDeviceType() {
      return getFieldShortValue(1, 0, Profile.SubFields.DEVICE_INFO_MESG_ANT_DEVICE_TYPE_FIELD_ANTPLUS_DEVICE_TYPE);
   }
   ...
   public void setAntplusDeviceType(Short antplusDeviceType) {
      setFieldValue(1, 0, antplusDeviceType, Profile.SubFields.DEVICE_INFO_MESG_ANT_DEVICE_TYPE_FIELD_ANTPLUS_DEVICE_TYPE);
   }
