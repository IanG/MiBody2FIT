...
public class EventMesg extends Mesg implements MesgWithEvent {
   ...
   static {            
      ...
      subfield_index++;
      eventMesg.fields.get(field_index).subFields.add(new SubField("sport_point", 134, 11, 0, ""));
    ...
    * @return sport_point
    */
   public Float getSportPoint() {
      return getFieldFloatValue(3, 0, Profile.SubFields.EVENT_MESG_DATA_FIELD_SPORT_POINT);
   }
    ...
    * @param sportPoint
    */
   public void setSportPoint(Float sportPoint) {
   ...
   /**
    * Get score field
    * Comment: Do not use.  Placeholder for sport_point subfield components
    *
    * @return score
    */
